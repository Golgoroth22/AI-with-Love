...
class ChatRepository(
    ...
    suspend fun getAllMessages(): List<ChatViewModel.Message> {
    ...
    suspend fun saveUserMessage(message: ChatViewModel.Message) {
        val entity =
            UserMessageEntity(
                text = message.text,
    ...
    suspend fun saveAssistantMessage(message: ChatViewModel.Message) {
        val entity =
    ...
    suspend fun getSummary(): ChatViewModel.Message? {
    ...
    private fun UserMessageEntity.toMessage(): ChatViewModel.Message =
        ChatViewModel.Message(
            text = text,
            isFromUser = true,
            timestamp = timestamp
    ...
    private fun AssistantMessageEntity.toMessage(): ChatViewModel.Message =
        ChatViewModel.Message(
            text = text,
            isFromUser = false,
            timestamp = timestamp,
