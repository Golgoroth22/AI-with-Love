...
class ChatViewModelProductionTest {
    ...
    @Test
    fun `initial MCP dialog is not shown`() = runTest {
        createViewModel()
    ...
    @Test
    fun `initial MCP servers list is not empty`() = runTest {
        createViewModel()
    ...
    @Test
    fun `joke server exists in MCP servers`() = runTest {
        createViewModel()
    ...
    @Test
    fun `toggleMcpDialog shows dialog`() = runTest {
        createViewModel()
    ...
    @Test
    fun `toggleMcpDialog hides dialog when shown`() = runTest {
        createViewModel()
    ...
    @Test
    fun `toggleMcpServer changes enabled state`() = runTest {
        createViewModel()
    ...
    @Test
    fun `toggleMcpServer twice restores original state`() = runTest {
        createViewModel()
    ...
    @Test
    fun `toggleMcpServer only affects target server`() = runTest {
        createViewModel()
    ...
    @Test
    fun `sendMessage with empty string does nothing`() = runTest {
        createViewModel()
    ...
    @Test
    fun `sendMessage with whitespace only does nothing`() = runTest {
        createViewModel()
    ...
    @Test
    fun `sendMessage calls repository to save user message`() = runTest {
        createViewModel()
    ...
    @Test
    fun `sendMessage calls API service`() = runTest {
        createViewModel()
    ...
    @Test
    fun `clearChat calls repository methods`() = runTest {
        createViewModel()
    ...
    @Test
    fun `clearChat resets messages to welcome only`() = runTest {
        createViewModel()
    ...
    @Test
    fun `loadChatHistory called during initialization`() = runTest {
        createViewModel()
    ...
    @Test
    fun `loads saved messages from repository`() = runTest {
    ...
    @Test
    fun `joke keywords with enabled server passes tools to API`() = runTest {
        createViewModel()
    ...
    @Test
    fun `regular message without tools passes null tools`() = runTest {
        createViewModel()
    ...
    @Test
    fun `tool execution triggers MCP client call`() = runTest {
        createViewModel()
        ...
        val toolCallResponse = AgenticResponse(
            output = listOf(
                OutputItem(
                    type = "function_call",
                    name = "get_joke",
        ...
        val finalResponse = AgenticResponse(
        ...
        coEvery {
            ...
            if (callCount++ == 0) Result.success(toolCallResponse)
            else Result.success(finalResponse)
        }
    ...
    @Test
    fun `response includes token usage information`() = runTest {
        createViewModel()
        ...
        val messages = viewModel.messages.value
        val responseMessage = messages.findLast {
