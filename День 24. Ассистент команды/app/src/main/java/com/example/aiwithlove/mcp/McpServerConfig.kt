                ...
                tools =
                    listOf(
                        ...
                        McpToolInfo(
                            name = "list_users",
                            emoji = "👥",
                            description = "Получить список пользователей CRM",
                            triggerWords = listOf("Support", "пользователи", "users", "клиенты")
                        ),
                        McpToolInfo(
                            name = "create_task",
                            emoji = "➕",
                            description = "Создать новую задачу для команды",
                            triggerWords = listOf("создай задачу", "новая задача", "добавить задачу")
                        ),
                        McpToolInfo(
                            name = "list_tasks",
                            emoji = "📋",
                            description = "Список задач с фильтрацией",
                            triggerWords = listOf("задачи", "список задач", "покажи задачи")
                        ),
                        McpToolInfo(
                            name = "update_task",
                            emoji = "✏️",
                            description = "Обновить задачу (статус, приоритет, исполнитель)",
                            triggerWords = listOf("обновить задачу", "изменить задачу", "назначить")
                        ),
                        McpToolInfo(
                            name = "get_task",
                            emoji = "📄",
                            description = "Получить детали задачи с историей",
                            triggerWords = listOf("задача", "детали задачи", "информация о задаче")
                        ),
                        McpToolInfo(
                            name = "get_team_workload",
                            emoji = "👥",
                            description = "Загрузка команды и доступность",
                            triggerWords = listOf("загрузка команды", "кто свободен", "workload")
                        ),
                        McpToolInfo(
                            name = "search_similar_tasks",
                            emoji = "🔍",
                            description = "Поиск похожих задач (семантический)",
                            triggerWords = listOf("похожие задачи", "дубликаты", "поиск задач")
                        )
                    ),
                isEnabled = false
            )
